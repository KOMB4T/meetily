...
/// Custom fork profile for Russian systems analyst meeting protocol.
pub const SA_MEETING_PROTOCOL: &str = include_str!("../../../templates/sa_meeting_protocol.json");
...
pub fn get_builtin_templates() -> Vec<(&'static str, &'static str)> {
    vec![
        ...
        ("sa_meeting_protocol", SA_MEETING_PROTOCOL),
    ]
}
...
pub fn get_builtin_template(id: &str) -> Option<&'static str> {
    match id {
        ...
        "sa_meeting_protocol" => Some(SA_MEETING_PROTOCOL),
        _ => None,
    }
}
...
pub fn list_builtin_template_ids() -> Vec<&'static str> {
    vec!["daily_standup", "standard_meeting", "sa_meeting_protocol"]
}
...
mod tests {
    ...
    fn test_get_builtin_template() {
        ...
        assert!(get_builtin_template("sa_meeting_protocol").is_some());
